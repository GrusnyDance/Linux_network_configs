...
Откройте файл /etc/sysctl.conf и добавьте в него строку net.ipv4.ip_forward = 1
При использовании этого подхода, IP-переадресация включена на постоянной основе

![task_5_10](./screens/5.10.png)
<b>измененный файл на роутере 1</b>

![task_5_11](./screens/5.11.png)
<b>измененный файл на роутере 2</b>

### 5.3. Установка маршрута по-умолчанию

Настроить маршрут по-умолчанию для рабочих станций. Для этого добавить gateway4 [ip роутера] в файле конфигураций
